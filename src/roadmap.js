...
export function setupRoadmapAscii() {
  const asciiCanvas = document.querySelector('canvas[data-component="roadmap-ascii"]')
  if (!asciiCanvas) return null

  const roadmapSection = asciiCanvas.closest('.section.cc-roadmap')
